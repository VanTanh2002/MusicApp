...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
  ...
  /**
   * @see VinylGlideExtension#artistOptions(BaseRequestOptions, Artist)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideRequest<TranscodeType> artistOptions(Artist artist) {
    return (GlideRequest<TranscodeType>) VinylGlideExtension.artistOptions(this, artist);
  }

  /**
   * @see VinylGlideExtension#songOptions(BaseRequestOptions, Song)
   */
  @SuppressWarnings("unchecked")
  @CheckResult
  @NonNull
  public GlideRequest<TranscodeType> songOptions(Song song) {
    return (GlideRequest<TranscodeType>) VinylGlideExtension.songOptions(this, song);
  }
}
