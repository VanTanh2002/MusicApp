...
public class GlideRequests extends RequestManager {
  ...
  /**
   * @see VinylGlideExtension#asBitmapPalette(RequestBuilder)
   */
  @NonNull
  @CheckResult
  public GlideRequest<BitmapPaletteWrapper> asBitmapPalette() {
    return (GlideRequest<BitmapPaletteWrapper>) VinylGlideExtension.asBitmapPalette(this.as(BitmapPaletteWrapper.class));
  }
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.poupa.vinylmusicplayer.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.poupa.vinylmusicplayer.glide.GlideOptions().apply(toSet));
    }
  }
}
