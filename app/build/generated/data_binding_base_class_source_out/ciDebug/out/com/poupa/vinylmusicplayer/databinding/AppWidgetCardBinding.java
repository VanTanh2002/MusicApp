...
public final class AppWidgetCardBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout appWidgetCard;
  ...
  private AppWidgetCardBinding(@NonNull FrameLayout rootView, @NonNull LinearLayout appWidgetCard,
    ...
    this.appWidgetCard = appWidgetCard;
  ...
  public static AppWidgetCardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.app_widget_card;
      LinearLayout appWidgetCard = ViewBindings.findChildViewById(rootView, id);
      ...
      return new AppWidgetCardBinding((FrameLayout) rootView, appWidgetCard, buttonNext, buttonPrev,
