...
public final class ActivityAlbumDetailBinding implements ViewBinding {
  ...
  private ActivityAlbumDetailBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView artistIcon, @NonNull TouchInterceptHorizontalScrollView artistScrollview,
      @NonNull AutoTruncateTextView artistText, @NonNull FrameLayout cabHolder,
      @NonNull ImageView durationIcon, @NonNull TextView durationText, @NonNull LinearLayout header,
      @NonNull View headerOverlay, @NonNull ImageView image,
      @NonNull MaterialCardView imageBorderTheme, @NonNull WidthFitSquareLayout imageContainer,
      @NonNull ObservableRecyclerView list, @NonNull ImageView songCountIcon,
      @NonNull TextView songCountText, @NonNull AutoTruncateTextView title,
    ...
    this.artistScrollview = artistScrollview;
  ...
  public static ActivityAlbumDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView albumYearIcon = ViewBindings.findChildViewById(rootView, id);
      if (albumYearIcon == null) {
        break missingId;
      }

      id = R.id.album_year_text;
      TextView albumYearText = ViewBindings.findChildViewById(rootView, id);
      if (albumYearText == null) {
        break missingId;
      }

      id = R.id.artist_icon;
      ImageView artistIcon = ViewBindings.findChildViewById(rootView, id);
      if (artistIcon == null) {
        break missingId;
      }

      id = R.id.artist_scrollview;
      TouchInterceptHorizontalScrollView artistScrollview = ViewBindings.findChildViewById(rootView, id);
      if (artistScrollview == null) {
        break missingId;
      }

      id = R.id.artist_text;
      AutoTruncateTextView artistText = ViewBindings.findChildViewById(rootView, id);
      if (artistText == null) {
        break missingId;
      }
      ...
      id = R.id.list;
      ObservableRecyclerView list = ViewBindings.findChildViewById(rootView, id);
      if (list == null) {
        break missingId;
      }
      ...
      return new ActivityAlbumDetailBinding((LinearLayout) rootView, albumYearIcon, albumYearText,
          artistIcon, artistScrollview, artistText, cabHolder, durationIcon, durationText, header,
          headerOverlay, image, imageBorderTheme, imageContainer, list, songCountIcon,
          songCountText, title, titleScrollview, toolbar);
    }
