...
public final class AppWidgetBigBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout appWidgetBig;
  ...
  private AppWidgetBigBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout appWidgetBig, @NonNull ImageButton buttonNext,
  ...
  public static AppWidgetBigBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      RelativeLayout appWidgetBig = (RelativeLayout) rootView;
      ...
      return new AppWidgetBigBinding((RelativeLayout) rootView, appWidgetBig, buttonNext,
          buttonPrev, buttonTogglePlayPause, clickableArea, image, mediaActions, mediaTitles, text,
          title);
    }
