...
public final class ItemListSingleRowBinding implements ViewBinding {
  ...
  private ItemListSingleRowBinding(@NonNull FrameLayout rootView, @NonNull IconImageView dragView,
      ...
      @NonNull View separator, @NonNull View shortSeparator, @NonNull TextView text,
  ...
  public static ItemListSingleRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListSingleRowBinding((FrameLayout) rootView, dragView, image, imageBorderTheme,
          imageContainer, imageText, menu, separator, shortSeparator, text, title, titleScrollview,
