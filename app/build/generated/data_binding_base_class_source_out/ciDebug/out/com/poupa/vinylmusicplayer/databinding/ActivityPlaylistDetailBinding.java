...
public final class ActivityPlaylistDetailBinding implements ViewBinding {
  ...
  private ActivityPlaylistDetailBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout cabHolder, @NonNull TextView empty,
      @NonNull FastScrollRecyclerView recyclerView, @NonNull AutoTruncateTextView title,
  ...
  public static ActivityPlaylistDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPlaylistDetailBinding((FrameLayout) rootView, cabHolder, empty,
          recyclerView, title, titleScrollview, toolbar, touchInterceptFramelayout);
    }
