...
public final class FragmentLibraryBinding implements ViewBinding {
  ...
  private FragmentLibraryBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appbar,
      @NonNull FrameLayout cabHolder, @NonNull ViewPager pager, @NonNull TabLayout tabs,
  ...
  public static FragmentLibraryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLibraryBinding((CoordinatorLayout) rootView, appbar, cabHolder, pager,
          tabs, toolbar);
    }
