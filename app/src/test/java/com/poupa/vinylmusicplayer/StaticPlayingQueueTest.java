...
public class StaticPlayingQueueTest {
    ...
    private StaticPlayingQueue init() {
        ...
        Song song1 = new Song(id_a, "a", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
        Song song2 = new Song(id_b, "b", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
        Song song3 = new Song(id_c, "c", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
        Song song4 = new Song(id_d, "d", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
    ...
    public void add_Song() throws Exception {
        ...
        // test
        List<String> artistName = new ArrayList<>();
        Song song1 = new Song(id_e, "e", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
    ...
    public void addAll_Songs() throws Exception {
        ...
        List<String> artistName = new ArrayList<>();
        Song song1 = new Song(id_e, "e", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
        Song song2 = new Song(id_f, "f", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
    ...
    public void removeSongs_OnCurrentPosition() throws Exception {
        ...
        List<String> artistName = new ArrayList<>();
        Song song1 = new Song(id_a, "a", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
        Song song2 = new Song(id_c, "c", 0, 2022, 50, "", 0, 0, 0, "", 0, artistName);
